...
export default async function PortfolioPage() {
  ...
  return <div className="mx-auto max-w-6xl px-4 py-8"><h1 className="text-2xl font-semibold tracking-tight">Portfolio</h1><p className="mt-1 text-sm text-zinc-500 dark:text-zinc-400">Your holdings, live prices, and current allocation.</p><PortfolioClient userId={user.id} instruments={instruments} initialHoldings={holdings} initialQuotes={quotes} /></div>;
}
