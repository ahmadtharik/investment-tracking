...
const paths: Record<AppIconName, ReactNode> = {
  ...
  settings: <><circle cx="12" cy="12" r="3" /><path d="M12 3.25h1.6l.55 2.2 1.55.9 2.1-.8 1.15 1.15-.8 2.1.9 1.55 2.2.55V13.5l-2.2.55-.9 1.55.8 2.1-1.15 1.15-2.1-.8-1.55.9-.55 2.2H12l-.55-2.2-1.55-.9-2.1.8-1.15-1.15.8-2.1-.9-1.55-2.2-.55v-1.6l2.2-.55.9-1.55-.8-2.1L7.8 5.55l2.1.8 1.55-.9z" /></>,
